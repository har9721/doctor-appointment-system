<form id="patientEditForm" enctype="multipart/form-data">
    ...
    <fieldset class="border border-warning p-3 rounded mb-4">
        ...
        <div class="row mb-4">
            <div class="col-md-3">
                <label for="name"><b>Name<span style="color: red;">*</span><span style="color: red;">*</span> : </b></label>
                <input type="text" class="form-control" id="name" name="name" value="{{ optional($patientsData->emergencyContact)->contact_name }}" placeholder="enter name">
            </div>
    
            <div class="col-md-3">
                <label for="contact_relation"><b>Relation with contact person<span style="color: red;">*</span><span style="color: red;">*</span> :</b></label>
                <input type="text" class="form-control" id="contact_relation" value="{{ optional($patientsData->emergencyContact)->contact_relation }}" name="contact_relation" placeholder="enter relation with contact">
            </div>
    
            <div class="col-md-3">
                <label for="contact_no"><b>Contact No<span style="color: red;">*</span><span style="color: red;">*</span> :</b></label>
                <input type="text" class="form-control" id="contact_no" value="{{ optional($patientsData->emergencyContact)->phone_no }}" name="contact_no" placeholder="enter contact no">
            </div>
        </div>
    </fieldset>
    ...
    <fieldset class="border border-warning p-3 rounded mb-4">
        ...
        <div class="row mb-4">
            <div class="col-md-3">
                ...
                <textarea id="past_illness" rows="1" name="past_illness" class="form-control">{{ optional($patientsData->medicalHistory)->illness }}</textarea>
            </div>
            <div class="col-md-3">
                <label for=""><b>Chronic Condition<span style="color: red;">*</span> :</b></label>
                <textarea id="chronic_condition" rows="1" name="chronic_condition" class="form-control">{{ optional($patientsData->medicalHistory)->chronicDisease }}</textarea>
            </div>
            <div class="col-md-3">
                <label for=""><b>Surgeries<span style="color: red;">*</span> : </b></label>
                <textarea id="surgeries" rows="1" name="surgeries" class="form-control">{{ optional($patientsData->medicalHistory)->surgery }}</textarea>
            </div>
            <div class="col-md-3">
                <label for="allergies"><b>Allergies<span style="color: red;">*</span> : </b></label>
                <textarea id="allergies" name="allergies" rows="1" class="form-control">{{ optional($patientsData->medicalHistory)->allergies }}</textarea>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <textarea name="medication" rows="1" class="form-control" id="medication">{{ optional($patientsData->medicalHistory)->medication }}</textarea>
            </div>
        </div>
    </fieldset>
    ...
    <fieldset class="border border-warning p-3 rounded mb-4">
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <select name="smoking_status" id="smoking_status" class="form-control">
                </select>
            ...
            <div class="col-md-3">
                ...
                <select name="alcohol_status" rows="1" id="alcohol_status" class="form-control">
                </select>
            ...
            <div class="col-md-3">
                ...
                <textarea name="exercise" id="exercise" rows="1" class="form-control"> {{ optional($patientsData->lifeStyleInformation)->exercise }}</textarea>
            </div>
        </div>
    </fieldset>
