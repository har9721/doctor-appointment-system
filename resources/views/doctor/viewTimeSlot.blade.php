            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="start_time" id="start_time" class="form-control datetimepicker" value="" placeholder="select time...">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="end_time" id="end_time" class="form-control datetimepicker" value="" placeholder="select time...">
